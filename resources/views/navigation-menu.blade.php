<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @elseif($role === 'coordinateur')
                <x-responsive-nav-link href="/coordinateur" :active="request()->is('coordinateur')">
                    {{ __('Dashboard Coordinateur') }}
                </x-responsive-nav-link>
            @elseif($role === 'professeur')
                <x-responsive-nav-link href="/professeur" :active="request()->is('professeur')">
                    {{ __('Dashboard Professeur') }}
                </x-responsive-nav-link>
            @elseif($role === 'etudiant')
                <x-responsive-nav-link href="/etudiant" :active="request()->is('etudiant')">
                    {{ __('Dashboard Étudiant') }}
                </x-responsive-nav-link>
            @endif
        </div>
